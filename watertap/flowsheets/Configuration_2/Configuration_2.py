...
def build_flowsheet(erd_type1=None, erd_type2=None, elec_type=None):
    m = build(erdtype1=erd_type1,erdtype2=erd_type2,elec_type=elec_type)
...
def build(erd_type1=None, erd_type2=None, elec_type=None):
    ...
    desal.FP.P1 = Pump(property_package=m.fs.prop_od)
    desal.FP.RO = ReverseOsmosis0D(
        property_package=m.fs.prop_od,
    ...
    desal.FP.RO.width.setub(5000)
    desal.FP.RO.area.setub(20000)
    if erd_type1 == "pressure_exchanger":
        desal.FP.S1 = Separator(property_package=m.fs.prop_od, outlet_list=["FP.P1", "FP.PXR"])
        desal.FP.M1 = Mixer(property_package=m.fs.prop_od, momentum_mixing_type=MomentumMixingType.equality,
                         inlet_list=["FP.P1", "FP.P2"])
        desal.FP.PXR = PressureExchanger(property_package=m.fs.prop_od)
        desal.FP.P2 = Pump(property_package=m.fs.prop_od)
    elif erd_type1 == "pump_as_turbine":
        desal.FP.ERD = EnergyRecoveryDevice(property_package=m.fs.prop_od)
    else:
    ...
    desal.FP.disposal = Product(property_package=m.fs.prop_od)

    
    #Desalination (2nd Pass)
    desal.SP.P1 = Pump(property_package=m.fs.prop_od)
    desal.SP.RO = ReverseOsmosis0D(
        property_package=m.fs.prop_od,
        has_pressure_change=True,
        pressure_change_type=PressureChangeType.calculated,
        mass_transfer_coefficient=MassTransferCoefficient.calculated,
    ...
    if erd_type2 == "pressure_exchanger":
        desal.SP.S1 = Separator(property_package=m.fs.prop_od, outlet_list=["SP.P1", "SP.PXR"])
        desal.SP.M1 = Mixer(property_package=m.fs.prop_od, momentum_mixing_type=MomentumMixingType.equality,
                            inlet_list=["SP.P1", "SP.P2"])
        desal.SP.PXR = PressureExchanger(property_package=m.fs.prop_od)
        desal.SP.P2 = Pump(property_package=m.fs.prop_od)
    ...
    desal.SP.disposal = Product(property_package=m.fs.prop_od)
    ...
    prtrt.s10 = Arc(source=prtrt.mfiltration.byprodcut, destination=prtrt.mbackwash_pump.inlet)
   ...
   #Pretreatment --> Lithium extraction
    ...
    if erd_type1 == "pressure_exchanger":
        ...
        m.fs.s_tb_desal = Arc(source=m.fs.tb_Lixstor_desal.outlet, destination=desal.FP.S1.inlet)
        desal.s01 = Arc(source=desal.FP.S1.FP.P1, destination=desal.FP.P1.inlet)
        desal.s02 = Arc(source=desal.FP.P1.outlet, destination=desal.FP.M1.FP.P1)
        desal.s03 = Arc(source=desal.FP.M1.outlet, destination=desal.FP.RO.inlet)
        desal.s04 = Arc(source=desal.FP.RO.retentate, destination=desal.FP.PXR.brine_inlet)
        desal.s05 = Arc(source=desal.FP.S1.FP.PXR, destination=desal.FP.PXR.feed_inlet)
        desal.s06 = Arc(source=desal.FP.PXR.feed_outlet, destination=desal.FP.P2.inlet)
        desal.s07 = Arc(source=desal.FP.P2.outlet, destination=desal.FP.M1.FP.P2)
        m.fs.FP_s_disposal = Arc(
            source=desal.FP.PXR.brine_outlet, destination=desal.FP.disposal.inlet
        )
    elif erd_type1 == "pump_as_turbine":
        m.fs.s_tb_desal = Arc(source=m.fs.tb_Lixstor_desal.outlet, destination=desal.FP.P1.inlet)
        desal.s01 = Arc(source=desal.FP.P1.outlet, destination=desal.FP.RO.inlet)
        desal.s02 = Arc(source=desal.FP.RO.retentate, destination=desal.FP.ERD.inlet)
        m.fs.FP_s_disposal = Arc(
            source=desal.ERD.outlet, destination=desal.FP.disposal.inlet
        )
    
    #Second Pass Desalination
    if erd_type2 == "pressure_exchanger" and erd_type2 == "pressure_exchanger":
        desal.s09 = Arc(source=desal.FP.RO.permeate, destination=desal.SP.S1.inlet)
        desal.s10 = Arc(source=desal.SP.S1.SP.P1, destination=desal.SP.P1.inlet)
        desal.s11 = Arc(source=desal.SP.P1.outlet, destination=desal.SP.M1.SP.P1)
        desal.s12 = Arc(source=desal.SP.M1.outlet, destination=desal.SP.RO.inlet)
        desal.s13 = Arc(source=desal.SP.RO.retentate, destination=desal.SP.PXR.brine_inlet)
        desal.s14 = Arc(source=desal.SP.S1.SP.PXR, destination=desal.SP.PXR.feed_inlet)
        desal.s15 = Arc(source=desal.SP.PXR.feed_outlet, destination=desal.SP.P2.inlet)
        desal.s16 = Arc(source=desal.SP.P2.outlet, destination=desal.SP.M1.SP.P2)
        m.fs.SP_s_disposal = Arc(
            source=desal.SP.PXR.brine_outlet, destination=desal.SP.disposal.inlet
        )
    elif erd_type2 == "pressure_exchanger" and erd_type2 == "pump_as_turbine":
        desal.s09 = Arc(source=desal.FP.RO.permeate, destination=desal.SP.P1.inlet)
        desal.s10 = Arc(source=desal.SP.P1.outlet, destination=desal.SP.RO.inlet)
        desal.s11 = Arc(source=desal.SP.RO.retentate, destination=desal.SP.ERD.inlet)
        m.fs.SP_s_disposal = Arc(
            source=desal.SP.ERD.outlet, destination=desal.SP.disposal.inlet
        )
    elif erd_type2 == "pump_as_turbine" and erd_type2 == "pressure_exchanger":
        desal.s04 = Arc(source=desal.FP.RO.permeate, destination=desal.SP.S1.inlet)
        desal.s05 = Arc(source=desal.SP.S1.SP.P1, destination=desal.SP.P1.inlet)
        desal.s06 = Arc(source=desal.SP.P1.outlet, destination=desal.SP.M1.SP.P1)
        desal.s08 = Arc(source=desal.SP.M1.outlet, destination=desal.SP.RO.inlet)
        desal.s09 = Arc(source=desal.SP.RO.retentate, destination=desal.SP.PXR.brine_inlet)
        desal.s10 = Arc(source=desal.SP.S1.SP.PXR, destination=desal.SP.PXR.feed_inlet)
        desal.s11 = Arc(source=desal.SP.PXR.feed_outlet, destination=desal.SP.P2.inlet)
        desal.s12 = Arc(source=desal.SP.P2.outlet, destination=desal.SP.M1.SP.P2)
        m.fs.SP_s_disposal = Arc (
            source=desal.SP.PXR.brine_outlet, destination=desal.SP.disposal.inlet
        )
    elif erd_type2 == "pump_as_turbine" and erd_type2 == "pump_as_turbine":
       desal.s04 = Arc(source=desal.FP.RO.permeate, destination=desal.SP.P1.inlet)
       desal.s05 = Arc(source=desal.SP.P1.outlet, destination=desal.SP.RO.inlet)
       desal.s06 = Arc(source=desal.SP.RO.retentate, destination=desal.SP.ERD.inlet) 
       m.fs.SP_s_disposal = Arc(
           source=desal.SP.ERD.outlet, destination=desal.SP.disposal.inlet
       )

    #Desalination --> Posttreatment
    m.fs.s_desal_tb = Arc(source=desal.SP.RO.permeate, destination=m.fs.tb_desal_psttrt.inlet)
    ...
    H2x.s03 = Arc(source=H2x.Compressor_H2.outlet, destinaton=H2x.prod_H2.inlet)
    ...
    #First pass desalination
    iscale.set_scaling_factor(desal.FP.P1.control_volume.work, 1e-5)
    iscale.set_scaling_factor(desal.FP.RO.area, 1e-4)
    if erd_type1 == "pressure_exchanger":
        iscale.set_scaling_factor(desal.FP.P2.control_volume.work, 1e-5)
        iscale.set_scaling_factor(desal.FP.PXR.feed_side.work, 1e-5)
        iscale.set_scaling_factor(desal.FP.PXR.brine_side.work, 1e-5)
    elif erd_type1 == "pump_as_turbine":
        iscale.set_scaling_factor(desal.FP.ERD.control_volume.work, 1e-5)
    
    #Second pass desalination
    iscale.set_scaling_factor(desal.SP.P1.control_volume.work, 1e-5)
    iscale.set_scaling_factor(desal.SP.RO.area, 1e-4)
    if erd_type2 == "pressure_exchanger":
        iscale.set_scaling_factor(desal.SP.P1.control_volume.work, 1e-5)
        iscale.set_scaling_factor(desal.SP.PXR.feed_side.work, 1e-5)
        iscale.set_scaling_factor(desal.SP.PXR.brine_side.work, 1e-5)
    elif erd_type2 == "pump_as_turbine":
        iscale.set_scaling_factor(desal.SP.ERD.control_volume.work, 1e-5)
...
def set_operating_conditions(m):
    ...
    #Chlorination
    m.db.get_unit_opeartation_parameters("chlorination")
    ...
    #Storage
    m.db.get_unit_operaation_parameters("storage_tank")
    ...
    desal.FP.P1.efficiency_pump.fix(0.80)
    operating_pressure = 70e5 * pyunits.Pa
    desal.FP.P1.control_volume.properties_out[0].pressure.fix(operating_pressure)

    #RO unit
    desal.FP.RO.A_comp.fix(4.2e-12) #membrane water permeability coefficient [m/s-Pa]
    desal.FP.RO.B_comp.fix(3.5e-8) #membrane salt permeability coefficient [m/s]
    desal.FP.RO.feed_side.channel_height.fix(1e-3) #channel height in membrane stage [m]
    desal.FP.RO.feed_side.spacer_porosity.fix(0.97) #spacer porosity in membrane stage [-]
    desal.FP.RO.permeate.pressure[0].fix(101325) 
    desal.FP.RO.width.fix(1000) #stage width [m]
    desal.FP.RO.area.fix(flow_vol * 4.5e4 * pyunits.s / pyunits.m) #stage area [m2] 

    if m.erd_type1 == "pressure_exchanger":
        #Splitter (no DOF)
        
        #Pressure exchanger (1 DOF)
        desal.FP.PXR.efficiency_pressure_exchanger.fix(0.95)

        #Pump 2 is a booster pump with (1 DOF, efficiency. Pressure must match the high pressure pump)
        desal.FP.P2.efficiency_pump.fix(0.80)

        #Mixer (no DOF)
    elif m.erd.type1 == "pump_as_turbine":
        #ERD, (2 DOF; effieciency and outlet pressure)
        desal.FP.ERD.efficiency_pump.fix(0.95)
        desal.FP.ERD.control_volume.properties_out[0].pressure.fix(101325)

    #Second pass desalination
    desal.SP.P1.efficiency_pump.fix(0.80)
    desal.SP.P1.control_volume.properties_out[0].pressure.fix(operating_pressure)

    #RO unit
    desal.SP.RO.A_comp.fix(4.2e-12)
    desal.SP.RO.B_comp.fix(3.5e-8)
    desal.SP.RO.feed_side.channel_height.fix(1e-3)
    desal.SP.RO.feed_side.spacer_porosity.fix(0.97)
    desal.SP.RO.permeate.pressure[0].fix(101325)
    desal.SP.RO.width.fix(1000)
    desal.SP.RO.area.fix(flow_vol * 4.5e4 * pyunits.s / pyunits.m)

    if m.erd_type2 == "pressure_exchanger":
        #Splitter (no DOF)

        #Pressure exchanger (1 DOF)
        desal.SP.PXR.efficiency_pressure_exchanger.fix(0.95)

        #Pump 2
        desal.SP.P2.efficiency_pump.fix(0.80)

        #Mixer (no DOF)
    elif m.erd.type2 == "pump_as_turbine":
        desal.SP.ERD.efficiency_pump.fix(0.95)
        desal.SP.ERD.control_volume.properties_out[0].pressure.fix(operating_pressure)
    ...
    m.db.get_unit_opearation_parameters("storage_tank")
    ...
    if m.elec_type == "PEM":
        ...
        H2x.ER.andoe_stoich["Liq", "H2O"].fix(2)
        H2x.ER.andoe_stoich["Liq", "O2-v"].fix(1)
    ...
    def intialize_system(m):
        ...
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["H2O"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "H2O"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["Li_+"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "Li_+"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["Ca_2+"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "Ca_2+"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["Mg_2+"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "Mg_2+"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["Cl_-"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "Cl_-"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["SO4_2-"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "SO4_2-"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["Na_+"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "Na_+"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["H_+"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "H_+"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["OH_-"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "OH_-"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["O2-v"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "O2-v"]
        )
        m.fs.tb_Lix_Lixstor.properties_out[0].flow_mass_comp["H2-v"] = value(
            m.fs.tb_Lix_Lixstor.properies_in[0].flow_mass_phase_comp["Liq", "H2-v"]
        )
        propagate_state(m.fs.s_tb_Lixstor)
        flags = fix_state_vars(Lixstor.storage.properties)
        solve(Lixstor, checkpoint="solve flowsheet after intializing Lithium Storage")
        ...
        #First Pass RO Unit
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "H2O"] = value(
            m.fs.feed_properties[0].flow_mass_comp["H2O"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Li_+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Li_+"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Ca_2+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Ca_2+"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Mg_2+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Mg_2+"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Cl_-"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Cl_-"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "SO4_2-"] = value(
            m.fs.feed_properties[0].flow_mass_comp["SO4_2-"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Na_+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Na_+"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "H_+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["H_+"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "OH_-"] = value(
            m.fs.feed_properties[0].flow_mass_comp["OH_-"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "O2-v"] = value(
            m.fs.feed_properties[0].flow_mass_comp["O2-v"]
        )
        desal.FP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "H2-v"] = value(
            m.fs.feed_properties[0].flow_mass_comp["H2-v"]
        )
        desal.FP.RO.feed_side.properties_in[0].temperature = value(
            m.fs.tb_prtrt_desal.properties_out[0].temperature
        )
        desal.FP.RO.feed_side.properties_in[0].pressure = value(
            desal.FP.P1.control_volume.properties_out[0].pressure
        )
        desal.FP.RO.initialize()
        
        propagate_state(m.fs.s_tb_desal)
        if m.erd_type1 == "pressure_exchanger":
            flags = fix_state_vars(desal.FP.S1.mixed_state)
            solve(
                desal,
                checkpoint=f"solve flowsheet after initializing {m.erd_type1, m.erd_type2, m.elec_type} system"
            )
            revert_state_vars(desal.FP.S1.mixed_state, flags)
        elif m.erd_type == "pump_as_turbine":
            flags = fix_state_vars(desal.FP.P1.control_volume.properties_in)
            solve(
                desal, 
                checkpoint=f"solve flowsheet after initializing {m.erd_type1, m.erd_type2, m.elec_type} system"
            )
            revert_state_vars(desal.FP.P1.control_volume.properties_in, flags)

        #Second Pass RO Unit
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "H2O"] = value(
            m.fs.feed_properties[0].flow_mass_comp["H2O"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Li_+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Li_+"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Ca_2+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Ca_2+"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Mg_2+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Mg_2+"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Cl_-"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Cl_-"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "SO4_2-"] = value(
            m.fs.feed_properties[0].flow_mass_comp["SO4_2-"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "Na_+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["Na_+"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "H_+"] = value(
            m.fs.feed_properties[0].flow_mass_comp["H_+"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "OH_-"] = value(
            m.fs.feed_properties[0].flow_mass_comp["OH_-"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "O2-v"] = value(
            m.fs.feed_properties[0].flow_mass_comp["O2-v"]
        )
        desal.SP.RO.feed_side.properties_in[0].flow_mass_phase_comp["Liq", "H2-v"] = value(
            m.fs.feed_properties[0].flow_mass_comp["H2-v"]
        )
        desal.SP.RO.feed_side.properties_in[0].temperature = value(
            m.fs.tb_prtrt_desal.properties_out[0].temperature
        )
        desal.SP.RO.feed_side.properties_in[0].pressure = value(
            desal.SP.P1.control_volume.properties_out[0].pressure
        )
        desal.SP.RO.initialize()
        ...
        solve(H2xstor, checkpoint="solve flowsheet after intializing gas storage")
    ...
    def optimize_operation(m): 
        ...
        #First pass RO unit
        desal.FP.P2.control_volume.properties_out[0].pressure.unfix()
        desal.FP.P2.control_volume.properties_out[0].pressure.setub(8300000)
        desal.FP.P2.control_volume.properties_out[0].pressure.setlb(100000)

        #First pass RO inlet velocity
        desal.FP.RO.feed_side.velocity[0, 0].unfix()
        desal.FP.RO.feed_side.velocity[0, 0].setub(0.3)
        desal.FP.RO.feed_side.velocity[0, 0].setlb(0.1)

        #First pass RO membrane area
        desal.FP.RO.area.unfix()
        desal.FP.RO.area.setub(5000)
        desal.FP.RO.area.setlb(50)

        #First pass RO recovery
        desal.FP.RO.recovery_vol_phase[0, "Liq"].unfix()
        desal.FP.RO.recovery_vol_phase[0, "Liq"].setub(0.99)
        desal.FP.RO.recovery_vol_phase[0, "Liq"].setlb(0.1)

        #Second pass RO unit
        desal.SP.P2.control_volume.properties_out[0].pressure.unfix()
        desal.SP.P2.control_volume.properties_out[0].pressure.setub(8300000)
        desal.SP.P2.control_volume.properties_out[0].pressure.setlb(100000)

        #Second pass Ro inlet velocity
        desal.SP.RO.feed_side.velocity[0, 0].unfix()
        desal.SP.RO.feed_side.velocity[0, 0].setub(0.3)
        desal.SP.RO.feed_side.velocity[0, 0].setub(0.1)

        #Second pass RO membrane area
        desal.SP.RO.area.unfix()
        desal.SP.RO.area.setub(5000)
        desal.SP.RO.area.setlb(50)

        #Second pass RO recovery
        desal.SP.RO.recovery_vol_phase[0, "Liq"].unfix()
        desal.SP.RO.recovery_vol_phase[0, "Liq"].setub(0.99)
        desal.SP.RO.recovery_vol_phase[0, "Liq"].setlb(0.1)
    ...
    def display_results(m):
        ...
        m.fs.pretreatment.gbackwash.report()
        ...
        if m.erd_type1 == "pressure_exchanger":
            m.fs.desalination.FP.S1.report()
            m.fs.desalination.FP.P1.report()
            m.fs.desalination.FP.P2.report()
            m.fs.desalination.FP.M1.report()
            m.fs.desalination.FP.RO.report()
            m.fs.desalination.FP.PXR.report()
        elif m.erd_type1 == "pump_as_turbine":
            m.fs.desaliantion.FP.P1.report()
            m.fs.desalination.FP.RO.report()
            m.fs.desalination.FP.ERD.report()
        m.fs.desalination.FP.disposal.report()
        if m.erd_type2 == "pressure_exchanger":
            m.fs.desalination.SP.S1.report()
            m.fs.desalination.SP.P1.report()
            m.fs.desalination.SP.P2.report()
            m.fs.desalination.SP.M1.report()
            m.fs.desalination.SP.RO.report()
            m.fs.desalination.SP.PXR.report()
        elif m.erd_type2 == "pump_as_turbine":
            m.fs.desalination.SP.P1.report()
            m.fs.desalination.FP.RO.report()
            m.fs.desalination.SP.ERD.report()
        m.fs.desalination.SP.disposal.report()
        m.fs.postreatment.IX.report()
        m.fs.postreatment.storage.report()
        if m.elec_type == "PEM":
            ...
            m.fs.H2extraction.ER.report()
            m.fs.H2extration.Compressor_O2.report()
            m.fs.H2extraction.Compressor_H2.report()
            m.fs.H2extraction.prod_O2.report()
            m.fs.H2extraction.prod_H2.report()
    ...
    def add_costing(m):
        ...
        prtrt.sedimentation = UnitModelCostingBlock(flowhseet_costing_block=m.fs.zo_costing)
        ...
        prtrt.gbackwash = UnitModelCostingBlock(flowsheet_costing_block=m.fs.zo_costing)
        ...
        desal.FP.P1.costing = UnitModelCostingBlock(
            flowsheet_costing_block=m.fs.od_costing,
            costing_method_argurments={"cost_electricity_flow": True},
        )
        desal.FP.RO.costing = UnitModelCostingBlock(flowsheet_costing_block=m.fs.od_costing)
        if m.erd_type1 == "pressure_exchanger":
            desal.FP.S1.costing = UnitModelCostingBlock(flowsheet_costing_block=m.fs.od_costing)
            desal.FP.M1.costing = UnitModelCostingBlock(flowsheet_costing_block=m.fs.od_costing)
            desal.FP.PXR.costing = UnitModelCostingBlock(flowsheet_costing_blocking=m.fs.od_costing)
            desal.FP.P2.costing = UnitModelCostingBlock(
                flowsheet_costing_block=m.fs.od_costing,
        ...
        desal.SP.P1.costing = UnitModelCostingBlock(
            flowsheet_costing_block=m.fs.od_costing,
            costing_method_arguments={"cost_electricity_flow": True},
        )
        desal.SP.RO.costing= UnitModelCostingBlock(flowsheet_costing_block=m.fs.od_costing)
        if m.erd_type2 == "pressure_exchanger":
            desal.SP.S1.costing = UnitModelCostingBlock(flowsheet_costing_block=m.fs.od_costing)
            desal.SP.M1.costing = UnitModelCostingBlock(flowsheet_costing_block=m.fs.od_costing)
            desal.SP.PXR.costing = UnitModelCostingBlock(flowsheet_costing_block=m.fs.od_costing)
            desal.SP.P2.costing = UnitModelCostingBlock(
                flowsheet_costing_block=m.fs.od_costing,
                costing_method_arguments={"cost_electricity_flow": True},
            )
        elif m.erd_type2 == "pump_as_turbine":
            desal.SP.ERD.costing = UnitModelCostingBlock(flowsheet_costing_block=m.fs.od_costing)
        else:
            raise ConfigurationError(
        ...
        m.fs.zo_costing.cost_flow(desal.FP.P1.work_mechanical[0], "electricity")
        if m.erd_type1 == "pressure_exchanger":
            m.fs.zo_costing.cost_flow(desal.FP.P2.work_mechanical[0], "electricity")
        elif m.erd_type1 == "pump_as_turbine":
            m.fs.zo_costing.cost_flow(desal.FP.ERD.work_mechanical[0], "electricity")
        else:
            raise ConfigurationError(
                f"erd_type1 was {m.erd_type1}, costing only implemented "
                "for pressure_exchanger or pump_as_turbine"
            )
        m.fs.zo_costing.cost_flow(desal.SP.P1.work_mechanical[0], "electricity")
        if m.erd_type2 == "pressure_exchanger":
            m.fs.zo_costing.cost_flow(desal.SP.P2.work_mechanical[0], "electricity")
        elif m.erd_type2 == "pump_as_turbine":
            m.fs.zo_costing.cost_flow(desal.SP.ERD.work_mechanical[0], "electricity")
        else:
            raise ConfigurationError(
                f"erd_type2 was {m.erd_type2}, costing only implemented "
                "for pressure_exchanger or pump_as_turbine"
        ...
        #Aggregate unit level costs and calcualte overall process costs
        ...
        m.fs.specific_energy_intenisty = Expression(
            expr=(
        ...
        m.fs.brine_cost = Expression(
            expr=(
                ...
                * (
                    ...
                    * pyunits.convert(
                        desal.FP.disposal.properties[0].flow_vol
                        + desal.SP.disposal.properties[0].flow_vol,
        ...
        m.fs.sludge_disposal.Cost = Expression(
            expr=(
                m.fs.zo_costing.utilization_factor
                * (
                    m.fs.zo_costing.waste_disposal_cost
                    * pyunits.convert(
                        prtrt.mbackwash_pump.properties[0].flow_vol
                        + prtrt.gbackwash_pump.properties[0].flow_vol,
                        to_units=pyunits.m**3 / m.fs.zo_costing.base_period,
        ...
        m.fs.water_recovery_revenue = Expression(
            expr=(
                ...
                * pyunits.convert(
                    ...
                    + desal.FP.RO.permeate.properties[0].flow_vol
                    + desal.SP.RO.permeate.properties[0].flow_vol,
                    to_units=pyunits.m**3 / m.fs.zo_costing.base_period,
                )
            ),
